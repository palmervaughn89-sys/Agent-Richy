...
// ── Lazy-loaded card components (reduces initial bundle ~200kB) ─────────
const CouponStack = dynamic(() => import("./CouponStack"));
const ExpenseInputCard = dynamic(() => import("./ExpenseInputCard"));
const SavingsReportCard = dynamic(() => import("./SavingsReportCard"));
const NegotiationScriptCard = dynamic(() => import("./NegotiationScriptCard"));
const SpendToSaveCard = dynamic(() => import("./SpendToSaveCard"));
const MarketReportCard = dynamic(() => import("./MarketReportCard"));
const AnalystInsightCard = dynamic(() => import("./AnalystInsightCard"));
const SectorOutlookCard = dynamic(() => import("./SectorOutlookCard"));
const PriceComparisonCard = dynamic(() => import("./PriceComparisonCard"));
const StoreRankingCard = dynamic(() => import("./StoreRankingCard"));
const SubscriptionValueCard = dynamic(() => import("./SubscriptionValueCard"));
const GoalSimulatorCard = dynamic(() => import("./GoalSimulatorCard"));
const BillPredictorCard = dynamic(() => import("./BillPredictorCard"));
const LocalDealCard = dynamic(() => import("./LocalDealCard"));
const ReceiptAnalysisCard = dynamic(() => import("./ReceiptAnalysisCard"));
const ConsensusLeaderboardCard = dynamic(() => import("./ConsensusLeaderboardCard"));
const StockConsensusCard = dynamic(() => import("./StockConsensusCard"));
const SectorConsensusCard = dynamic(() => import("./SectorConsensusCard"));
const InvestmentThemeCard = dynamic(() => import("./InvestmentThemeCard"));
const GroceryPlanCard = dynamic(() => import("./GroceryPlanCard"));
const AllocationPlanCard = dynamic(() => import("./AllocationPlanCard"));
const ProactiveAlertCard = dynamic(() => import("./ProactiveAlertCard"));
const WeeklyDigestCard = dynamic(() => import("./WeeklyDigestCard"));
const FinancialHealthDashboard = dynamic(() => import("./FinancialHealthDashboard"));
const WealthProjectionCard = dynamic(() => import("./WealthProjectionCard"));
const FinancialTwinCard = dynamic(() => import("./FinancialTwinCard"));
const WealthRaceCard = dynamic(() => import("./WealthRaceCard"));
const AdvisorMatchCard = dynamic(() => import("./AdvisorMatchCard"));
const LifeEventSelector = dynamic(() => import("./LifeEventSelector"));
const MoneyMapCard = dynamic(() => import("./MoneyMapCard"));
const RippleTrackerCard = dynamic(() => import("./RippleTrackerCard"));
const RippleEffectCard = dynamic(() => import("./RippleEffectCard"));
const EconomicImpactCard = dynamic(() => import("./EconomicImpactCard"));
const DealPredictionCard = dynamic(() => import("./DealPredictionCard"));
const PurchaseTimingCard = dynamic(() => import("./PurchaseTimingCard"));
